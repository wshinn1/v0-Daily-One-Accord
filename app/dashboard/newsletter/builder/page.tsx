...
import { EmailBuilderFullPage } from "@/components/email-builder/email-builder-full-page"
...
export default async function EmailBuilderPage({
  ...
  return (
    ...
    >
      <EmailBuilderFullPage churchTenantId={tenantId} userId={user.id} initialTemplate={template} />
    </DashboardLayout>
  )
}
